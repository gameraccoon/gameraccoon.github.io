+++
date = '2026-01-02T14:05:44+01:00'
draft = false
title = 'Non-gaming projects'
menus = 'main'
weight = 30
+++
...
[easy-photo-backup](https://github.com/gameraccoon/easy-photo-backup) - an in-development project for simple and secure photo and video backup over Wi-Fi.
...
[Spy Game Bot](https://spy-game.gameraccoon.com) - a small Telegram bot for playing a couple of hidden identity games with a party of friends offline. Only one player needs a Telegram account to play.

Written in Go.

[The King Says Bot](https://king.gameraccoon.com) - a small Telegram bot for playing a variation on truth-or-dare or ōsama with a party of friends offline. Only one player needs a Telegram account to play.

Written in Go.

[Riichi Trainer Bot](https://t.me/riichi_trainer_bot) - a Telegram bot for practicing tile efficiency for riichi mahjong.

Written in Rust.

[Riichi Scoring Trainer Bot](https://t.me/RiichiScoringTrainerBot) - a tiny bot for practicing score calculation for riichi mahjong.

Written in Rust.

[Random Shuffle Bot](https://t.me/RandomShuffleBot) - a small bot for randomizing lists and doing drafts.
